...
export const createPesquisaHandler = asyncHandler(async (req: Request, res: Response) => {
...
export const getPesquisas = asyncHandler(async (req: Request, res: Response) => {
...
export const getPesquisaByIdHandler = asyncHandler(async (req: Request, res: Response) => {
...
export const updatePesquisaHandler = asyncHandler(async (req: Request, res: Response) => {
  const pesquisa = await updatePesquisa(req.params.id, req.body as UpdatePesquisaBody)
  if (!pesquisa) throw new AppError('Pesquisa não encontrada.', 404)
  res.json({ success: true, data: pesquisa })
})
...
export const deletePesquisaHandler = asyncHandler(async (req: Request, res: Response) => {
