...
export const metadata: Metadata = {
  ...
  description:
    "Envie fotos, vídeos ou trabalhos acadêmicos para o acervo digital do CAFTA.",
};
            ...
            <div className="max-w-lg mx-auto">
              <div className="mb-10">
                ...
                <p className="text-white/50 mt-3 text-sm leading-relaxed">
                  Envie suas fotos, vídeos ou trabalhos acadêmicos para compor o
                  acervo digital do Centro Acadêmico Frei Tito de Alencar.
                </p>
              </div>
