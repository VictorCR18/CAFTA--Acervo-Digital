    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6 py-24 text-center">
        ...
        <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-white mt-3 mb-6 animate-slide-up">
          SITE{' '}
          <span className="text-cafta-gold">CAFTA</span>
        </h1>

        <p className="text-white/70 text-lg md:text-xl max-w-xl mx-auto mb-10 leading-relaxed animate-fade-in">
          Um <em className="text-cafta-gold-light not-italic">acervo digital</em> da História — fotos,
          vídeos e produções acadêmicas do curso de História da UFC.
        </p>
        ...
        {SLIDES.map((_, i) => (
          <button
            ...
            className={`h-1 rounded-full transition-all duration-300 ${
              i === current ? 'bg-cafta-gold w-8' : 'bg-white/30 w-4 hover:bg-white/60'
            }`}
          />
        ))}
      </div>
